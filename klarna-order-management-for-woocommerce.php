 ...
 */
define( 'WC_KLARNA_ORDER_MANAGEMENT_VERSION', '1.9.4' );
...
if ( ! class_exists( 'WC_Klarna_Order_Management' ) ) {
	...
	class WC_Klarna_Order_Management {
		...
		public function init() {
			...
			include_once WC_KLARNA_ORDER_MANAGEMENT_PLUGIN_PATH . '/classes/class-wc-klarna-order-scheduled-actions.php';
