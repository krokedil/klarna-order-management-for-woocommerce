	...
	$( document ).ready( function () {
		const kom = {
			...
			update_klarna_refund_amount: function() {
				...
				const refundFeeAmount = kom.unformat_number($klarnaReturnFeeAmountField.val()) + kom.unformat_number($klarnaReturnFeeTaxAmountField.val());
			...
			on_refund_submit: function (e) {
				...
				const diff = kom.unformat_number($refundAmount.val()) - (kom.unformat_number($klarnaReturnFeeAmountField.val()) + kom.unformat_number($klarnaReturnFeeTaxAmountField.val()));
